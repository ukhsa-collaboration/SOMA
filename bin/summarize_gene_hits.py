...
def extract_genefinder_hits(genefinder_results):
	if genefinder_results == "None":
		genefinder = pd.DataFrame(columns=['gene_name', 'source'])
	else:
...
def parse_args():
	...
	parser.add_argument('--genefinder', required=False, help="GeneFinder results")
...
def main():
	...
	if args.genefinder:
		...
		genefinder = extract_genefinder_hits("None")
