process SUMMARIZE_RESULTS {
    ...
    def in_17 = input_files.toString().contains(".fastp.json") ? "--fastp RESULTS/*.fastp.json" : ""
    def in_18 = input_files.toString().contains(".metamlst_cc.tsv") ? "--metamlst RESULTS/*.metamlst_cc.tsv" : ""
    def in_19 = input_files.toString().contains(".multiqc_report_data") ? "--multiqc RESULTS/*.multiqc_report_data/multiqc_general_stats.txt" : ""
