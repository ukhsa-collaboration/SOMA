process RESFINDER {
    ...
    container "${ workflow.containerEngine == 'singularity' && !task.ext.singularity_pull_docker_container ?
        'docker://genomicepidemiology/resfinder:4.4.2':
        'docker://staphb/resfinder:4.1.11' }"
    ...
    """
    python -m resfinder -ifa $assembly -o ${prefix} --acquired --point ${organism_param_1} "${organism_param_2}" $args 
    mv */*.txt ./
